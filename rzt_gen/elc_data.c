/* generated ELC source file - do not edit */
        ...
        const elc_cfg_t g_elc_cfg = {
            ...
            .link[ELC_PERIPHERAL_ENCIF_TRG0] = ELC_EVENT_GPT0_OVF, /* GPT0_OVF (GPT0 GTCNT overflow (GTPR compare match)) */
            .link[ELC_PERIPHERAL_ENCIF_TRG1] = ELC_EVENT_GPT0_OVF, /* GPT0_OVF (GPT0 GTCNT overflow (GTPR compare match)) */
